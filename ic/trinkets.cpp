...
trinket_ladder_t::trinket_ladder_t() {
    ...
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Reaper's Harvest" ), 124513, 726, 0, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Reaper's Harvest" ), 124513, 735, 0, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Reaper's Harvest" ), 124513, 741, 0, 0, 0, 0, 0, 1 ) );
