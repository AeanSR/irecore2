...
trinket_ladder_t::trinket_ladder_t() {
    list.clear();
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Vial of Convulsive Shadows" ), 113969, 670, 334, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Vial of Convulsive Shadows" ), 113969, 676, 354, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Vial of Convulsive Shadows" ), 113969, 685, 385, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Vial of Convulsive Shadows" ), 113969, 691, 407, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Vial of Convulsive Shadows" ), 113969, 700, 443, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Vial of Convulsive Shadows" ), 113969, 706, 468, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Forgemaster's Insignia" ), 113983, 670, 335, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Forgemaster's Insignia" ), 113983, 676, 355, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Forgemaster's Insignia" ), 113983, 685, 386, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Forgemaster's Insignia" ), 113983, 691, 408, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Forgemaster's Insignia" ), 113983, 700, 444, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Forgemaster's Insignia" ), 113983, 706, 469, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Horn of Screaming Spirits" ), 119193, 670, 283, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Horn of Screaming Spirits" ), 119193, 676, 299, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Horn of Screaming Spirits" ), 119193, 685, 325, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Horn of Screaming Spirits" ), 119193, 691, 344, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Horn of Screaming Spirits" ), 119193, 700, 374, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Horn of Screaming Spirits" ), 119193, 706, 395, 0, 0, 0, 0, 0 ) );
    ...
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Tectus' Beating Heart" ), 113645, 655, 216, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Tectus' Beating Heart" ), 113645, 661, 228, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Tectus' Beating Heart" ), 113645, 670, 248, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Tectus' Beating Heart" ), 113645, 676, 262, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Tectus' Beating Heart" ), 113645, 685, 285, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Tectus' Beating Heart" ), 113645, 691, 302, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Bottle of Infesting Spores" ), 113658, 655, 228, 134, 0, 0, 134, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Bottle of Infesting Spores" ), 113658, 661, 241, 141, 0, 0, 141, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Bottle of Infesting Spores" ), 113658, 670, 262, 154, 0, 0, 154, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Bottle of Infesting Spores" ), 113658, 676, 277, 163, 0, 0, 163, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Bottle of Infesting Spores" ), 113658, 685, 301, 177, 0, 0, 177, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Bottle of Infesting Spores" ), 113658, 691, 319, 187, 0, 0, 187, 0 ) );
    ...
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Mote of the Mountain" ), 116292, 640, 175, 0, 0, 0, 0, 0 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Mote of the Mountain" ), 116292, 646, 185, 0, 0, 0, 0, 0 ) );
    ...
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Discordant Chorus" ), 124237, 700, 397, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Discordant Chorus" ), 124237, 706, 420, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Discordant Chorus" ), 124237, 715, 456, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Discordant Chorus" ), 124237, 721, 482, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Discordant Chorus" ), 124237, 730, 525, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Discordant Chorus" ), 124237, 736, 555, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Empty Drinking Horn" ), 124238, 700, 397, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Empty Drinking Horn" ), 124238, 706, 420, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Empty Drinking Horn" ), 124238, 715, 456, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Empty Drinking Horn" ), 124238, 721, 482, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Empty Drinking Horn" ), 124238, 730, 525, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Empty Drinking Horn" ), 124238, 736, 555, 0, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Unending Hunger" ), 124236, 695, 0, 758, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Unending Hunger" ), 124236, 701, 0, 800, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Unending Hunger" ), 124236, 710, 0, 871, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Unending Hunger" ), 124236, 716, 0, 922, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Unending Hunger" ), 124236, 725, 0, 1003, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Unending Hunger" ), 124236, 731, 0, 1060, 0, 0, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Rumbling Pebble" ), 124235, 690, 271, 0, 271, 271, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Rumbling Pebble" ), 124235, 696, 286, 0, 286, 286, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Rumbling Pebble" ), 124235, 705, 312, 0, 312, 312, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Rumbling Pebble" ), 124235, 711, 329, 0, 329, 329, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Rumbling Pebble" ), 124235, 720, 359, 0, 359, 359, 0, 1 ) );
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Rumbling Pebble" ), 124235, 726, 379, 0, 379, 379, 0, 1 ) );
    ...
    list.push_back( trinket_profile_t( QApplication::translate( "gicClass", "Mark of Supreme Doom" ), 124546, 705, 187, 0, 0, 0, 0, 1 ) );
