...
QString script_stat_maxima(
    ...
    for (int i = 0; i < 5; i++){
        const QString stats_name[] = {
            ...
            QApplication::translate("gicClass", "Multistrike"),
    ...
    script += "  return string.format(\"%d,%d,%d,%d,%d\",s[1],s[2],s[3],s[4],s[5])\n";
    script += "end\n";
    ...
    script += "  SetParam(\"gear_mult\", s[4])\n";
    script += "  SetParam(\"gear_vers\", s[5])\n";
    script += "  return\n";
    script += "end\n";
